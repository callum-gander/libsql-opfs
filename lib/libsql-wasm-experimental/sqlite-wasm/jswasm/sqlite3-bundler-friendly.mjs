...
globalThis.sqlite3ApiBootstrap.initializersAsync.push(async (sqlite3)=>{
  try{
    ...
    sqlite3.config.log("proxyJs", proxyJs);
    if(sqlite3.scriptInfo.sqlite3Dir){
      installOpfsVfs.defaultProxyUri =
        sqlite3.scriptInfo.sqlite3Dir + proxyJs;
      sqlite3.config.log("sqlite3Dir", sqlite3.scriptInfo.sqlite3Dir);
      sqlite3.config.log("installOpfsVfs.defaultProxyUri", installOpfsVfs.defaultProxyUri);
    }
